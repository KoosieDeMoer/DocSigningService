...
public class SigUtils {
	 ...
	 *         1, 2 or 3. 2 is also returned if the DocMDP transform parameters dictionary is found but did not contain
	 *         a /P entry, or if the value is outside the valid range.
	 */
	...
	/**
	 * Set the access permissions granted for this document in the DocMDP transform parameters dictionary. Details are
	 * described in the table "Entries in the DocMDP transform parameters dictionary" in the PDF specification.
	 * 
	 * @param doc
	 *            The document.
