...
public abstract class CreateSignatureBase implements SignatureInterface {
	 ...
	 */
	public CreateSignatureBase(String alias, KeyStore keystore, char[] pin) throws KeyStoreException,
	...
	private SignerInformation signTimeStamp(SignerInformation signer) throws IOException, TSPException {
		...
		SignerInformation newSigner = SignerInformation.replaceUnsignedAttributes(signer, new AttributeTable(
				signedAttributes));
	...
	public byte[] sign(InputStream content) throws IOException {
		...
		try {
			...
			gen.addSignerInfoGenerator(new JcaSignerInfoGeneratorBuilder(new JcaDigestCalculatorProviderBuilder()
					.build()).build(sha1Signer, new X509CertificateHolder(cert.getEncoded())));
	...
	/**
	 * Set if external signing scenario should be used. If {@code false}, SignatureInterface would be used for signing.
	 * <p>
	 * Default: {@code false}
	 * </p>
	 * 
